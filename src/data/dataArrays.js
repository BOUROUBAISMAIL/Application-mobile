export const categories = [
  {
    ...
    name: 'Dog',
    photo_url:
    'https://img2.storyblok.com/filters:format(webp)/f/124182/1200x628/9f3357036b/chiot-berger-australien.jpg'
  },
  {
    id: 1,
    name: 'cat',
    photo_url: 'https://www.petfinder.com/static/9e651d309070f05859e1ec722220b13d/93c27/Shelter_cat_01_1.webp'
  },
  {
    id: 2,
    name: 'others',
...
export const recipes = [
  {
    recipeId: 122,
    categoryId: 3,
    title: 'Chiot Berger Australien',
    photo_url: 'https://img2.storyblok.com/filters:format(webp)/f/124182/800x419/174f578f27/chien-berger-australien.jpg',
    photosArray: [
      'https://img2.storyblok.com/filters:format(webp)/f/124182/800x419/174f578f27/chien-berger-australien.jpg'],
    time: '15',
    ingredients: [[0, '200ml'], [1, '5g'], [2, '300g']],
    description:
      "Les associations et refuges sont la plupart du temps à but non lucratif et ont pour majeure préoccupation d’offrir un abri aux chiens sans propriétaires. Les animaux peuvent provenir de fourrières, être abandonnés par leurs maîtres ou encore égarés et jamais retrouvés par leurs propriétaires.Cela ne veut pas dire pour autant que votre chiot de Berger australien sera en mauvaise santé ! La grande majorité de ces lieux ont à cœur d’offrir des conditions de vie dignes et confortables à leurs animaux même si, malheureusement, ils disposent d’un espace limité au vu du grand nombre de boules de poils qu ils accueillent chaque jour. "
  },
  {
    recipeId: 2,
    categoryId: 3,
    title: 'Chiot Berger Allemand',
    photo_url: 'https://img2.storyblok.com/filters:format(webp)/f/124182/800x419/174f578f27/chien-berger-australien.jpg',
    photosArray: [
      'https://img2.storyblok.com/filters:format(webp)/f/124182/800x419/174f578f27/chien-berger-australien.jpg'],
    time: '30',
    ...
    description:
      'Cela ne veut pas dire pour autant que votre chiot de Berger australien sera en mauvaise santé ! La grande majorité de ces lieux ont à cœur d’offrir des conditions de vie dignes et confortables à leurs animaux même si, malheureusement, ils disposent d’un espace limité au vu du grand nombre de boules de poils qu’ils accueillent chaque jour. Quand bien même votre chiot aurait subi des violences, le rôle d’un refuge ou d’une association est de lui apporter tous les soins nécessaires dont il aurait besoin ainsi qu’une socialisation afin qu’il puisse interagir avec les humains sans crainte'
  },
  {
    recipeId: 3,
    categoryId: 3,
    title: 'chiots de Berger',
    photo_url:
      'https://v.fastcdn.co/u/dacf0b1a/60617295-0-13-20220115-155953.jpeg',
    photosArray: [
      'https://v.fastcdn.co/u/dacf0b1a/60617295-0-13-20220115-155953.jpeg' ],
    time: '45',
    ingredients: [
    ...
    description:
      'Le berger australien est un chien de taille moyenne à grande. Très populaire à travers le monde, il est aujourd’hui à la fois utilisé pour la conduite des troupeaux, mais également comme chien de compagnie apprécié par de nombreuses familles. Descendant de chiens importés du Pays-Basque aux États-Unis, il a ensuite été exporté en Australie au début du XXe siècle. Intelligent, protecteur et affectueux, c’est aussi un chien très actif qui a besoin de se dépenser longuement chaque jour pour rester en bonne santé. Gentil avec tout le monde, y compris les autres animaux, le Berger australien est idéal pour les familles avec enfant. Le poil de ce beau chien peut de plus arborer de nombreuses couleurs : noir, rouge, bleu merle et rouge merle ou encore tricolore. Les yeux du Berger australien ont la particularité d’être souvent de couleur différente. Plus étonnant encore, il arrive qu’un de leurs yeux soient de plusieurs couleurs, ce qui fait de ce chien un animal encore plus unique !'
  },
  {
    recipeId: 1,
    categoryId: 3,
    title: 'Berger Australien LOF',
    photo_url: 'https://v.fastcdn.co/u/dacf0b1a/60617365-0-01-3f7cd3fc-44f6-4a2.jpeg',
    photosArray: [
      'https://v.fastcdn.co/u/dacf0b1a/60617365-0-01-3f7cd3fc-44f6-4a2.jpeg'],
    time: '30',
    ingredients: [
      [1, '2 tablespoons'],
      [3, '1 tablespoon'],
    ...
    description:
      'Il est tout à fait possible d’adopter un chiot ou un chien adulte Berger australien en refuge ! Mieux encore : nous vous encourageons à le faire ! En adoptant dans un refuge ou une association, vous sauvez deux vies : celle de votre futur compagnon à quatre pattes et celle du chien qui prendra sa place. Il est tout à fait possible de trouver et adopter un Berger australien dans un refuge. La race est populaire. Hélas, les abandons ne sont pas rares. Là encore, prenez le temps de bien vous renseigner. Vérifiez les conditions de vie dans le refuge et le carnet de vaccination. Essayez également de vous renseigner sur l’état de santé de l’animal (maladies connues, statut des vermifuges, etc.), ainsi que sur son passé (parents, conditions de vie, raisons de l’abandon, etc.). '
  },
  {
    recipeId: 4,
    categoryId: 1,
    ...
    photo_url: 'https://www.petfinder.com/static/9e651d309070f05859e1ec722220b13d/93c27/Shelter_cat_01_1.webp',
    photosArray: [
      'https://www.petfinder.com/static/9e651d309070f05859e1ec722220b13d/93c27/Shelter_cat_01_1.webp' ],
    time: '35',
    ingredients: [
      [30, 'jucie of 1 '],
      [24, '2 teaspoons'],
    ...
    description:
    "Buying kittens for sale and cats for sale could cost hundreds of dollars; hundreds more if a cat or kitten's medical history is unknown or if the kitty has not received initial medical care.  Think adoption first! Find lovable cats or baby kittens for sale that you’ve searched for online at your nearest animal shelter or rescue group for a reasonable adoption fee.When you search for cats on Petfinder.com, 11,000 shelter and rescue groups introduce you to more than 100,000 adoptable cats and kittens, who can be filtered by:HOW MUCH IS A CAT?Any cat parent will tell you how priceless these small, furry family members are, from their entertaining, acrobatic prowess to their instant purring appreciation of your love and attention.  While no one can put a price on the endless hours of enjoyment you’ll have with your adopted kitty, an adoption fee helps cover the expenses of sheltering and caring for the pets in an adoption organization."
  },
  {
    recipeId: 5,
    categoryId: 1,
